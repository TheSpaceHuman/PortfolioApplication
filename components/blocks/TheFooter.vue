  <template>
    <footer class="footer bg--secondary" id="footer">
      <div class="container">
        ...
        <blockquote class="d-flex justify-content-center"><span class="mr-10">Made with</span><span class="d-flex"><img class="mini-icon" :src="image.src" :alt="image.alt" v-for="image in images" :key="image.alt"></span></blockquote>
      </div>
    </footer>
  </template>
